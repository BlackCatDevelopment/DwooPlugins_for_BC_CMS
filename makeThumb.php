...
function Dwoo_Plugin_makeThumb(Dwoo $dwoo, $file='', $prefix='', $width=200, $height=300, $quality=90) {
	...
	{
		require_once( CAT_PATH . '/modules/lib_images/inc/class.Images.php' );
		
		$imageHelper	= new Image( $file );
		$imageHelper->setPathToTempFiles( CAT_PATH . '/temp' );
		$imageHelper->resize( $width, $height, 'crop', $jpgQuality=$quality );
